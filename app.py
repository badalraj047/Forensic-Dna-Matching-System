...
app = Flask(__name__)
# Use an environment-provided secret key in production. Fall back to a generated key for
# development convenience. Set the SECRET_KEY env var on your host (Render, Heroku,
# Docker, etc.) to a persistent value.
